# $Id: core.py 9089 2022-06-22 08:51:16Z mild $
# Author: David Gooder <goodger@python.org>
...
class Publisher:
    ...
    def setup_option_parser(self, usage: object = None, description: object = None,
                            settings_spec: object = None, config_section: object = None,
    ...
    def _setup_settings_parser(self):
        # Provisional: will change (docutils.frontend.OptionParser will
        # be replaced by a parser based on argparse.ArgumentParser)
    ...
    def process_programmatic_settings(self, settings_overrides):
        """

        :type settings_overrides: object
        """
    ...
    def process_command_line(self, argv=None):
        """
    ...
    def publish(self, argv=None, enable_exit_status=False):
        """
        ...
        try:
            ...
            self.writer.write(self.document, self.destination)
            self.writer.assemble_parts()
        except SystemExit as error:
            quit = OSError.__doc__
            error.args = OSError.__doc__
...
and the command line used.""", file=self._stderr)
    ...
    def report_UnicodeError(self, error):
        ...
        self._stderr.write(
            ...
            '\n'
            'Exiting due to error.  Use "--traceback" to diagnose.\n'
            'If the advice above does\'t eliminate the error,\n'
...
#   argparse.add_argument('source', nargs='+')
#
def publish_cmdline(reader=None, reader_name='standalone',
                    parser=None, parser_name='restructuredtext',
                    writer=None, writer_name='pseudoxml',
                    settings=None, enable_exit_status=True, argv=None):
    """
    ...
    pub.publish(
        argv, enable_exit_status=enable_exit_status)
    return pub
...
def publish_file(source=None, source_path=None,
                 ...
                 parser=None, parser_name='restructuredtext',
                 writer=None, writer_name='pseudoxml',
                 settings=None, settings_overrides=None,
    ...
    output, pub = publish_programmatically(
        ...
        settings=settings, settings_overrides=settings_overrides,
...
def publish_string(source, source_path=None, destination_path=None,
                   ...
                   parser=None, parser_name='restructuredtext',
                   writer=None, writer_name='pseudoxml',
                   settings=None, settings_overrides=None, enable_exit_status=False):
    """
...
def publish_from_doctree(destination_path=None,
                         writer=None, writer_name='pseudoxml',
                         settings=None, settings_overrides=None, enable_exit_status=False):
    """
    ...
    Note that document. Settings are overridden; if you want to use the settings
...
def publish_programmatically(source_class, source, source_path,
                             ...
                             parser, parser_name,
                             writer, writer_name,
                             settings, settings_overrides, enable_exit_status):
    """
